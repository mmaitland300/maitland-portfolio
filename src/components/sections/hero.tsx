      ...
      <div className="cyber-frame mx-auto max-w-6xl px-6 py-32 text-center">
        ...
        >
          <div className="cyber-pill mb-6 inline-flex items-center gap-3 rounded-full px-4 py-2 text-xs font-medium uppercase tracking-[0.24em] text-[rgba(196,206,223,0.82)] backdrop-blur-sm">
            ...
            Systems Troubleshooting - Web Work - Audio DSP
          </div>
        </motion.div>
        ...
        >
          ...
          I build Research Radar for paper discovery, a bounded computer-vision
          experiment, and StringFlux, a JUCE plugin for guitar-forward granular delay.
          I also write and produce music as NEUROCHEMICAL ENTROPY. This site is where
          those threads meet: triage, software, and sound.
        </motion.p>
